...
void func_push(stack_t **head, unsigned int conter);
void func_pall(stack_t **head, unsigned int cont);
void func_pint(stack_t **head, unsigned int contr);
...
void func_mull(stack_t **head, unsigned int counter);
void func_modu(stack_t **head, unsigned int counter);
void func_puchar(stack_t **head, unsigned int count);
void func_pustr(stack_t **head, unsigned int count);
void func_rotll(stack_t **head, unsigned int counter);
